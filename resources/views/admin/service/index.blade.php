...
<div class="main-content">
    <div class="container">
        <h1 class="mb-4">Data Service</h1>

    <!-- Tombol Tambah Barang: Tidak Tampil untuk Kasir -->
    @if(auth()->user()->role !== 'kasir')
    <a href="{{ route('service.add') }}" class="btn btn-primary mb-3">Tambah Barang</a>
    @endif
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th>Nama Jasa</th>
                <th>Harga</th>
                <!-- Kolom Aksi: Tidak Tampil untuk Kasir -->
                @if(auth()->user()->role !== 'kasir')
                <th>Aksi</th>
                @endif
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Tombol Ubah dan Hapus: Tidak Tampil untuk Kasir -->
                    @if(auth()->user()->role !== 'kasir')
    ...
    <div class="d-flex justify-content-center align-items-center">
        ...
        <div>
            {{ $services->links('pagination::bootstrap-4') }}  <!-- Default Pagination links with Bootstrap -->
        </div>
    </div>
</div>