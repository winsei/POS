...
<div class="main-content">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('barang.delete', $barang->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
    ...
    <div class="d-flex justify-content-center align-items-center">
        ...
        <div>
            {{ $barangs->links('pagination::bootstrap-4') }}  <!-- Default Pagination links with Bootstrap -->
        </div>
    </div>
</div>