...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1 class="mb-4">Data Keuangan</h1>

            <!-- Tombol Tambah Service -->
            <a href="{{ route('transaksi.add') }}" class="btn btn-primary mb-3">Tambah Transaksi</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-actions">
                            <a href="{{ route('transaksi.edit', $transaksi->no_nota) }}" class="btn btn-warning btn-sm">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <a href="{{ route('transaksi.detail', $transaksi->no_nota) }}" class="btn btn-info btn-sm">
                                <i class="bi bi-eye"></i>
                            </a>
                            <form action="{{ route('transaksi.delete', $transaksi->no_nota) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
