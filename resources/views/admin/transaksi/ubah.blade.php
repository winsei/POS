...
<div class="container">
    ...
    <form action="{{ route('transaksi.update', $transaksi->no_nota) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input 
                ...
                no_nota="no_polisi" 
                name="no_polisi" 
                value="{{ old('no_polisi', $transaksi->no_polisi) }}" 
                required>
            @error('no_polisi')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <select 
                ...
                <option value="cash" {{ old('jenis_pembayaran', $transaksi->jenis_pembayaran) == 'cash' ? 'selected' : '' }}>Cash</option>
                <option value="debit" {{ old('jenis_pembayaran', $transaksi->jenis_pembayaran) == 'debit' ? 'selected' : '' }}>Debit</option>
            </select>
