...
<div class="container">
    <h1>Ubah Detail Barang</h1>

    <form action="{{ route('detail.barang.update', ['no_nota' => $transaksi->no_nota, 'id' => $detailBarang->id]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="barang_nama" name="barang_nama" value="{{ $detailBarang->barang->nama_barang }}" readonly>
        </div>
        <input type="hidden" name="barang_id" value="{{ $detailBarang->barang_id }}">
        

        <!-- Jumlah -->
        <div class="mb-3">
            <label for="jumlah" class="form-label">Jumlah</label>
            <input type="number" class="form-control" id="jumlah" name="jumlah" value="{{ $detailBarang->jumlah }}" min="0" required>
        </div>

        <!-- Harga -->
        <div class="mb-3">
            <label for="harga" class="form-label">Harga</label>
            <input type="number" step="0.01" class="form-control" id="harga" name="harga" value="{{ $detailBarang->harga }}" required>
        </div>

        <!-- Subtotal (Readonly) -->
        <div class="mb-3">
            <label for="subtotal" class="form-label">Subtotal</label>
            <input type="number" step="0.01" class="form-control" id="subtotal" name="subtotal" value="{{ $detailBarang->subtotal }}" readonly required>
        </div>
